...
const insertUserCard = async (userId, boardId, cardContent, priority) => {
  try {
    ...
    let allCards = [...await getCardsInfo()].map(card => {
...
// const deleteUserCard = async (userId, boardId) => {
//   try {
//     const uid = await getUid(userId);
